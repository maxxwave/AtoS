...
int H_total(){
    ...
    for  (int i=0; i<create::index; i++){
        st::H_total[i].x =  st::H_ani[i].x + 0.0*st::H_ex[i].x + st::H_applied[0];//create::index; // + others
        st::H_total[i].y =  st::H_ani[i].z + 0.0*st::H_ex[i].y + st::H_applied[1];//create::index; // + others
        st::H_total[i].z =  st::H_ani[i].z + 0.0*st::H_ex[i].z + st::H_applied[2];//create::index; // + others
    }
    return 0;
}//end of H_total
