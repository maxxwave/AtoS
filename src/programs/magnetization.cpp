...
namespace magnetization{
    void magnetization_out(){
      ...
      output <<times::time_step * program::time <<"\t"<< Mx/sqrt(Mx*Mx + My*My + Mz*Mz) << "\t" 
          << My/sqrt(Mx*Mx + My*My + Mz*Mz)  << "\t"
          << Mz/sqrt(Mx*Mx + My*My + Mz*Mz) << "\t" 
          << sqrt(Mx*Mx + My*My + Mz*Mz) <<"\t"
          << st::H_applied[2] << std::endl;

      std::cout << Mx/sqrt(Mx*Mx + My*My + Mz*Mz) << "\t"
                << My/sqrt(Mx*Mx + My*My + Mz*Mz)  << "\t"
                << Mz/sqrt(Mx*Mx + My*My + Mz*Mz)  << "\t" 
                << st::H_applied[2] << "\n";
